...
const Notifications = () => {
  ...
  const getIcon = (type) => {
    switch (type) {
      case "announcement":
        return <FaBullhorn className="text-warning" />;
      case "event":
        return <FaCalendarDays className="text-primary" />;
      case "message":
        ...
        <div className="list-group list-group-flush">
          {loading ? (
            ...
            notifications.map((notification) => (
              ...
              >
                <div className="fs-4 mt-1">{getIcon(notification.type)}</div>
                <div className="flex-grow-1">
                  <div className="d-flex justify-content-between">
                    <h6
                      className={`mb-1 ${!notification.read ? "fw-bold" : ""}`}
                    >
